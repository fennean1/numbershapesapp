...
export const hidden_eggs = {
  ...
  INTERACTIVE: { TYPE: CONST.INTERACTIVE_TYPES.SUBITIZER, SETUP: CONST.SETUPS.hidden_eggs }, // sent to "Interactive Selector"
  QUICK_START: {
    STEPS: [{ meta: "something", description: "Open the 'hidden eggs' interactive" },{ meta: "something", description: "Explore the features and show which eggs are 'hiding' " },{ meta: "something", description: "Use the 'chat' as a guide for discussion." }],
    META: "something",
  },
  LINKS: [
    {
...
export const subtraction_spheres = {
  ...
  SLIDES: [
    ...
    {
      sample_talk: [
        { actor: ACTORS.TEACHER, text: "Can you write a subtraction sentence from the picture?" },
        { actor: ACTORS.STUDENT, text: " 8 - 3 = 5" },
      ],
      url: "https://res.cloudinary.com/numbershapes/image/upload/v1653269443/Screen_Shot_2022-05-22_at_6.18.55_PM_tp4y5x.png",
    },
  ],
  INTERACTIVE: { TYPE: CONST.INTERACTIVE_TYPES.SUBITIZER, SETUP: CONST.SETUPS.subtraction_spheres }, // sent to "Interactive Selector"
  QUICK_START: {
    STEPS: [{ meta: "something", description: "Explore the interactive." },{ meta: "something", description: "Follow the sample talk in the slides." },{ meta: "something", description: "Use the worksheet linked below to practice." }],
    META: "something",
  },
  LINKS: [
    {
  ...
  SLIDES: [
    ...
    },
    {
      sample_talk: [
        ...
        {actor: ACTORS.STUDENT, text: "I can count by tens to see how many I collected!"}
      ],
      url: "https://res.cloudinary.com/numbershapes/image/upload/v1653526774/Screen_Shot_2022-05-25_at_8.59.01_PM_likal8.png"
    },

     ],
  INTERACTIVE: { TYPE: CONST.INTERACTIVE_TYPES.MATCH_GAME, SETUP: CONST.SETUPS.card_matching }, // sent to "Interactive Selector"
  QUICK_START: {
    STEPS: [{ meta: "something", description: "Open the game" },{ meta: "something", description: "Find matches until all the cards are gone." },{ meta: "something", description: "Count how many dots you collected!" }],
    META: "something",
  },
  LINKS: [   
    {
