...
export const prototype = {
  HEADER: {TITLE: "Hidden Eggs",SHORT_TEXT: "Adding and whole/part relationships."},
  INTRO: {TEXT: "In this activity learners use the number of visible eggs and the total to find how many are hidden."},
  SLIDES: [{text: "hello",url: "https://res.cloudinary.com/numbershapes/image/upload/v1652018182/Activities/Hidden%20Eggs/Screen_Shot_2022-05-08_at_9.54.15_AM_i701ut.png"}],
